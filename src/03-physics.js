...
class Game {
  ...
  init() {
    ...
    buttons[0].onclick = () => game.addBody()
    buttons[1].onclick = () => game.addBody(false)
  ...
  addBody(sphere = true) {
    ...
    const materialGround = new CANNON.ContactMaterial(
      this.groundMaterial,
      material,
      { friction: 0.0, restitution: sphere ? 0.9 : 0.3 }
    )

    this.world.addContactMaterial(materialGround)
  }
...
button1.innerHTML = 'Add Sphere'
const button2 = document.createElement('button')
button2.innerHTML = 'Add Box'
